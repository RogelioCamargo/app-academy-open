...
describe Dessert do
  let(:chef) { double("chef") }
	let(:dessert) { Dessert.new("brownie", 3, chef)}
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do 
			expect { Dessert.new("brownie", "3", chef) }.to raise_error(ArgumentError)
		end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do 
			ingredients = ["chocolate", "flour", "egg", "butter"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do 
			...
			expect(dessert.serve).to eq("Chef Roger the Great Baker has made 3 brownies!")
		end
  end
